...
describe('update introduce', () => {
  commonTest(
    'update introduce api common test',
    [
      {
        name: 'url test',
        ...
        globalThis.api
          ...
          .then((response) => {
            ...
            expect(unLink.mock.calls).toEqual([
              [expect.stringContaining(`\\public\\${htmlFilePath}`), expect.any(Function)],
              [expect.stringContaining(`\\public\\${jsonFilePath}`), expect.any(Function)],
            ]);
          ...
          .then((response) => {
            ...
            expect(response.body).toEqual({
              ...
              errors: expect.arrayContaining([
                expect.stringContaining(COMMON.FIELD_NOT_EXPECT.format(expectedFieldName)),
              ]),
            });
            done();
          });
